...
<template>
    <div class="container">
        ...
        'color':'black'
                ...
                <el-table-column prop="staffPhone" label="盘点时间" align="center"></el-table-column>
                <el-table-column prop="staffPhone" label="盘点类型" align="center"></el-table-column>
                <el-table-column prop="ruzhiTime" label="盘点数量" align="center"></el-table-column>
            </el-table>
        </div>
    </div>
</template>
